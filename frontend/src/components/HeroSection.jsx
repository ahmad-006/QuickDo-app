...
function HeroSection() {
  return (
    <div className="flex px-7 gap-8 flex-col justify-center mt-20 mx-auto items-center ">
      <div className="flex px-4 py-3 bg-[rgb(0,19,12)] rounded-3xl border-[0.5px]  border-[#003523]">
        <Zap color="#00D492" size={25} />{" "}
        <span className="ml-3 text-[#00D492]">Simple Task Management</span>
      </div>
      ...
      <div className="text-center text-gray-400 md:px-58 font-medium text-[18px] ">
        A lightweight todo app that helps you focus on what matters. No clutter,
        just simple task management that works.
      </div>

      <div>
        <button className="bg-[#04bc82] hover:bg-[#049064]  mr-4 rounded-[9px] transition-all duration-300 cursor-pointer  px-4 py-2 font-medium">
          Get Started Free
        </button>
